...
DYLIB_MINOR_NAME=$(DYLIBNAME).$(HIREDIS_SONAME)
DYLIB_MAJOR_NAME=$(DYLIBNAME).$(HIREDIS_MAJOR)
...
ifeq ($(findstring MINGW, $(uname_S)), MINGW)
  DYLIBSUFFIX=dll
  # dll import file must be called libhiredis.a, but real .dll must be hiredis.dll
  DYLIBNAME=hiredis.$(DYLIBSUFFIX)
  WIN_LDFLAGS=-lws2_32
endif
